...
#     os.path.join(IMG_DIR, "Startscherm.jpg")
# ).convert()

# floor_bg = pygame.image.load(
#     os.path.join(IMG_DIR, "stone floor.jpg")
# ).convert()
...
#     global player_dir
#     if keys[pygame.K_q]: player.x -= player_speed; player_dir="left"
#     if keys[pygame.K_d]: player.x += player_speed; player_dir="right"
#     if keys[pygame.K_z]: player.y -= player_speed; player_dir="up"
